...
- Part 4 - Creating a weighted routing policies

- Part 5- Creating Private Hosted Zone and records
...
```
4. Create "Windows" instance in "clarus-vpc-a" named "Windows"
...
### STEP 3: Create a Static WebSite Hosting :
...
## Part 5 - Creating Private Hosted Zone and DNS Records 
