...
# 1.Create Sec.Groups:
   ...
   Maria_dB_Sec.Grp: In bound :"Mysql 3306, SSH 22  > anywhere (0:/00000)"
...
# 3.Create MariaDB ec2 instance in PrivateB
...
Rule: Mysql 3306, SSH 22  >>>>>> "Wordpress/Bastion_Host Sec.Gruoup"
...
----> Warning!!! for upload of yum package, http must be allowed in NAT Instance's security group. 
